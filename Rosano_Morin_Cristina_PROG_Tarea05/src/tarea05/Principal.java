...
public class Principal {
	...
	public static void main(String[] args) {
		...
		miAlquiler.anadeTurismo(turismo5);
		...
		do {
			...
			case 7:// abrir alquiler
				...
				if (turismoBuscado == null)
					System.out.println("ERROR: No existe un vehÃ­culo con dicha matricula\n");
				else {
					try {
			...
			case 8:
				...
				if (turismoBuscado == null)
					System.out.println("ERROR: No existe un turismo con dicha matri­cula\n");
				else {
					try {
